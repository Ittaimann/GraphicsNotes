...
- [vulkan dev tutorial :)](https://vkguide.dev/)
- [opengl tutoria :\ ](https://learnopengl.com/)
## blogs
- [michael drobot's blog](https://michaldrobot.com/)
- [mcGuire blog](https://casual-effects.com/)
- [bart wronski blog](https://bartwronski.com/)
- [aras blog](https://aras-p.info/)
...
## etc
- [advances in realtime rendering](http://advances.realtimerendering.com/)
- [advances in realtime rendering architecture](http://enginearchitecture.realtimerendering.com/)
- [gpu open](https://gpuopen.com/)
- [dr arm issue 1(download link)](https://t.co/xW1VIX8ycr?amp=1)
## twitter accounts of note (there are a lot)
- [aras from unity](https://twitter.com/aras_p?lang=en)
- [arm mobile graphics](https://twitter.com/ArmMali)
- [Tom forsythe (graphics adjacent)](https://twitter.com/tom_forsyth)
- [brain karis](https://twitter.com/BrianKaris)
